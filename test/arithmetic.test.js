...
describe('Subtraction', function () {
    ...
    describe('Exponentiation', function () {
        ...
        it('raises a positive integer to the power of zero', function (done) {
            request.get('/arithmetic?operation=exponentiate&operand1=2&operand2=0')
                .expect(200)
                .end(function (err, res) {
        ...
        it('raises zero to the power of zero', function (done) {
            request.get('/arithmetic?operation=exponentiate&operand1=0&operand2=0')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 1 });
                    done();
        ...
        it('raises zero to a positive integer power', function (done) {
            request.get('/arithmetic?operation=exponentiate&operand1=0&operand2=3')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 0 });
                    done();
